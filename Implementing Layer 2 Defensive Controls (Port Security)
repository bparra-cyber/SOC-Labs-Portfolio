...
Switch Port Security Configuration and Syslog Logs![alt text](image.png)
...
Port Security Violation and Link Shutdown![alt text](image-1.png) ![alt text](image-2.png)
